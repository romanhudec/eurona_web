...
namespace Eurona.Controls
{
		public class AdminRolesControl: CmsControl
		{
				...
				private RadGrid CreateGridView()
				{
						...
						grid.MasterTableView.CommandItemSettings.AddNewRecordText = global::CMS.Resources.Controls.AdminRolesControl_NewRoleButton_Text;

						grid.Columns.Add( new GridBoundColumn
						{
								DataField = "Name",
								HeaderText = global::CMS.Resources.Controls.AdminRolesControl_ColumnName,
								SortExpression = "Name",
						...
						{
								DataField = "Notes",
								HeaderText = global::CMS.Resources.Controls.AdminRolesControl_ColumnNotes,
				...
				private void OnDeleteCommand( object sender, GridCommandEventArgs e )
				{
						...
						{
								this.Page.ClientScript.RegisterStartupScript( GetType(), "alert", "alert('" + global::CMS.Resources.Controls.AdminRolesControl_CanNotDeleteUsedRole_Message + "');", true );
						}
				}
		}
}
