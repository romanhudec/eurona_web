<%@ Page Language="C#" MasterPageFile="~/eshop/default.master" AutoEventWireup="true" Inherits="Eurona.EShop.GenericPageFB" Codebehind="pageFB.aspx.cs" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="content" Runat="Server">
    ...
    <asp:LinkButton runat="server" ID="btnFacebook" OnClick="OnSendToFacebook">
        <img id="Img2" runat="server" src="~/images/facebook.png" alt="share on facebook" style="border:0px none #fff;" />
    </asp:LinkButton>
    <asp:Label runat="server" ID="lblShare"></asp:Label>
