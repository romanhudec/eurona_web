<%@ Page Title="<%$ Resources:Strings, Navigation_ProductsCatalog %>" Language="C#" MasterPageFile="~/page.master" AutoEventWireup="true" CodeBehind="catalog_vanoce.aspx.cs" Inherits="Eurona.EShop.CatalogVanoce" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="content" runat="server">
    <div class="virtual-catalog" runat="server" id="vc_cs" visible="false">
        ...
        <embed src="/userfiles/virtual-catalog-vanoce/book_online.swf" base="/userfiles/virtual-catalog-vanoce/"
    ...
    <div class="virtual-catalog" runat="server" id="vc_pl" visible="false">
        <div style="margin:auto; width:100%;">
        <embed src="/userfiles/virtual-catalog-vanoce-pl/book_online.swf" base="/userfiles/virtual-catalog-vanoce-pl/"
            name="katalog" width="1024" height="700" align="middle" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" menu="false" allowFullScreen="false" bgcolor="#ffffff" allowScriptAccess="sameDomain" quality="high" wmode="transparent"/>
        </div>
    </div>
</asp:Content>
