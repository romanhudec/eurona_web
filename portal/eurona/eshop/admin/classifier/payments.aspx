<%@ Page Title="" Language="C#" MasterPageFile="~/eshop/admin/admin.master" AutoEventWireup="true" CodeBehind="payments.aspx.cs" Inherits="Eurona.EShop.Admin.Classifier.Payments" %>
<asp:Content ID="Content2" ContentPlaceHolderID="navigation" runat="server">
    <div class="navigation-links">
        ...
        <span>&nbsp;-&nbsp;</span>
		<a id="A5" href="~/eshop/admin/classifier/shipments.aspx" runat="server"><asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:EShopStrings, Navigation_Classifier_Payments %>" /></a>		        
	</div>
</asp:Content>
