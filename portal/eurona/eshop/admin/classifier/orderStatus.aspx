<%@ Page Title="" Language="C#" MasterPageFile="~/eshop/admin/admin.master" AutoEventWireup="true" CodeBehind="orderStatus.aspx.cs" Inherits="Eurona.EShop.Admin.Classifier.OrderStatusPage" %>
<asp:Content ID="Content2" ContentPlaceHolderID="navigation" runat="server">
    <div class="navigation-links">
        ...
        <span>&nbsp;-&nbsp;</span>
		<a id="A5" href="~/eshop/admin/classifier/orderStatuses.aspx" runat="server"><asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:EShopStrings, Navigation_Classifier_OrderStatuses %>" /></a>
		 <span>&nbsp;-&nbsp;</span>
		<asp:Literal runat="server" Text="<%$ Resources:EShopStrings, Navigation_Classifier_OrderStatus %>" />
	</div>
</asp:Content>
