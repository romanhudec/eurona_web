<%@ Page Title="" Language="C#" MasterPageFile="~/eshop/admin/admin.master" AutoEventWireup="true" CodeBehind="vat.aspx.cs" Inherits="Eurona.EShop.Admin.Classifier.VATPage" %>
<asp:Content ID="Content2" ContentPlaceHolderID="navigation" runat="server">
    <div class="navigation-links">
        ...
        <span>&nbsp;-&nbsp;</span>
		<a id="A5" href="~/eshop/admin/classifier/vats.aspx" runat="server"><asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:EShopStrings, Navigation_Classifier_VATs %>" /></a>
		 <span>&nbsp;-&nbsp;</span>
		<asp:Literal runat="server" Text="<%$ Resources:EShopStrings, Navigation_Classifier_VAT %>" />
	</div>
</asp:Content>
