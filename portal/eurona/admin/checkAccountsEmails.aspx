<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" Inherits="Eurona.Admin.CheckAccountsEmails" Codebehind="checkAccountsEmails.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
    <div>
        <h2>Kontrola duplicity emalů na účtech - zdvojené emaily</h2>
    </div>
    <br /><br />
