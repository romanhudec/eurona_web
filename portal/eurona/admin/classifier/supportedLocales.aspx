<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeBehind="supportedLocales.aspx.cs" Inherits="Eurona.Admin.Classifier.SupportedLocalesPage" %>
<asp:Content ID="Content5" ContentPlaceHolderID="navigation" Runat="Server">
    <div class="navigation-links">
        ...
        <span>&nbsp;-&nbsp;</span>
		<asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:Strings, Navigation_Classifier_SupportedLocales %>" />
	</div>
</asp:Content>
