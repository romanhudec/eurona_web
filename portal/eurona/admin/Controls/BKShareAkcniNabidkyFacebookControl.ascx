<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BKShareAkcniNabidkyFacebookControl.ascx.cs" Inherits="Eurona.admin.Controls.BKShareAkcniNabidkyFacebookControl" %>
<table>
    <tr>
