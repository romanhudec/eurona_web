...
{
		public class IconClassifiersControl<T>: CMS.Controls.CmsControl where T: ClassifierBase, new()
		{
				...
				{
						get { return GetSession<SortDirection>( "IconClassifiersControl-SortDirection", SortDirection.Ascending ); }
						set { SetSession<SortDirection>( "IconClassifiersControl-SortDirection", value ); }
				}
				public string SortExpression
				{
						get { return GetSession<string>( "IconClassifiersControl-SortExpression" ); }
						set { SetSession<string>( "IconClassifiersControl-SortExpression", value ); }
				}

				public IconClassifiersControl()
				{
				}
				...
				protected virtual RadGrid CreateGridControl()
				{
						...
						bf.DataField = "Code";
						bf.HeaderText = Resources.Strings.ClassifiersControl_ColumnCode;
						...
						ic.HeaderText = Resources.Strings.ClassifiersControl_ColumnIcon;
