<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BKShareSpecialniNabidkyFacebookControl.ascx.cs" Inherits="Eurona.admin.Controls.BKShareSpecialniNabidkyFacebookControl" %>
<table>
    <tr>
