...
namespace Eurona.admin.Controls {
    public partial class BKRegistracePodrizenehoControl : System.Web.UI.UserControl {
        private DAL.Entities.Classifiers.BonusovyKreditTyp typ = DAL.Entities.Classifiers.BonusovyKreditTyp.RegistracePodrizenehoPrvniObjednavka;
        protected void Page_Load(object sender, EventArgs e) {
            ...
            if (!Page.IsPostBack) {
                ...
                this.txtObjednavkaOd.Text = this.BonusovyKredit.HodnotaOd.ToString();
                this.txtKredit.Enabled = cbAktivni.Checked;
                this.txtObjednavkaOd.Enabled = cbAktivni.Checked;
        ...
        protected void OnSave(object sender, EventArgs e) {
            ...
            this.BonusovyKredit.HodnotaOd = Convert.ToDecimal(this.txtObjednavkaOd.Text);
