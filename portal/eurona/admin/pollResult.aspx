<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" Inherits="Eurona.Admin.PollResult" Codebehind="pollResult.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="Server">
	<cmsPoll:PollControl ID="pollControl" cssclass="poll"  runat="server" />
</asp:Content>
