<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeBehind="singleUserCookieReports1.aspx.cs" Inherits="Eurona.Admin.Reports.SingleUserCookieReports1Page" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="navigation" Runat="Server">
    <div class="navigation-links">
        ...
        <span>&nbsp;-&nbsp;</span>
		<asp:Literal ID="Literal4" runat="server" Text="Za vybrané období počet odeslaných cookie / uživatel" />
	</div>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <h2>Report - Za vybrané období počet odeslaných cookie / uživatel</h2>
    <table>
        <tr>
    ...
    <telerik:RadGrid AutoGenerateColumns="False" ID="gridView" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True" runat="server">
        ...
        <MasterTableView TableLayout="Fixed" PageSize = "50">
            <Columns>
                ...
                <telerik:GridBoundColumn HeaderText="Odeslaných cookies" DataField="Pocet" UniqueName="Pocet"
