<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" Inherits="Eurona.Admin.AddAccountCredit" Codebehind="addAccountCredit.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
	<cmsAccount:AdminAddAccountCreditControl runat="server" ID="adminAddAccountCreditControl" />
</asp:Content>
