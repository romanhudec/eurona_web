<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" Inherits="Eurona.Admin.LoggedAccountsPage" Codebehind="loggedAccounts.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
	<telerik:RadGrid AutoGenerateColumns="False" ID="gridView" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True" runat="server">
        ...
        <MasterTableView TableLayout="Fixed" PageSize = "50">
            <Columns>
                <telerik:GridHyperLinkColumn HeaderText="Kód" DataTextField="Code" DataNavigateUrlFields="Id"  UniqueName="Code" ItemStyle-Wrap="false" DataNavigateUrlFormatString="~/user/operator/user.aspx?id={0}&ReturnUrl=/user/operator/loggedAccounts.aspx"
