<%@ Page Title="<%$ Resources:Strings, Navigation_MyAccount %>" Language="C#" MasterPageFile="~/page.master" AutoEventWireup="true" CodeBehind="account.aspx.cs" Inherits="Eurona.User.AccountDetailPage" %>
