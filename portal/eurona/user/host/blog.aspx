<%@ Page Title="<%$ Resources:Strings, Navigation_Blog %>" Language="C#" MasterPageFile="~/user/host/page.master" AutoEventWireup="true" Inherits="Eurona.User.Host.Blog" Codebehind="blog.aspx.cs" %>
