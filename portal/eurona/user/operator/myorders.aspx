<%@ Page Title="" Language="C#" MasterPageFile="~/user/operator/admin.master" AutoEventWireup="true" CodeBehind="myorders.aspx.cs" Inherits="Eurona.User.Operator.MyOrdersPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="navigation" runat="server">
	<div class="navigation-links">
		...
		<span>&nbsp;-&nbsp;</span>
		<asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:EShopStrings, AdministrationMode_MyOrders %>" />
	</div>
</asp:Content>
    ...
    <style type="text/css">
     ...
     <div runat="server" id="divOrderAssociation">
        ...
        <fieldset id="fdsOrdersAssociation" style="width:95%;padding:10px;">
            <legend style="font-size:16px;color:#EA008A;font-weight:bold;padding-left:30px;"><asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:EShopStrings, Navigation_AssociateSelectedOrdersToAdvisor %>"></asp:Literal></legend>
     ...
     <div>
        <fieldset id="Fieldset1" style="width:95%;padding:10px;">
            <legend style="font-size:16px;color:#EA008A;font-weight:bold;padding-left:30px;">Hromadné potvrzení objednávek</legend>
            <asp:Button ID="btnCreateOrder" runat="server" Text="Objednat vybrané objednávky" CssClass="associateButton" OnClick="OnCreateOrder" />
        </fieldset>
     </div>
</asp:Content>
