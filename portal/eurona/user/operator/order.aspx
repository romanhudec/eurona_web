<%@ Page Title="" Language="C#" MasterPageFile="~/user/operator/admin.master" AutoEventWireup="true" CodeBehind="order.aspx.cs" Inherits="Eurona.Operator.OrderPage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
     <shpOrder:AdminOrderControl runat="server" ID="adminOrderControl" CssClass="adminOrderControl" CssGridView="dataGrid" FinishUrlFormat="~/user/operator/orderFinish.aspx?id={0}" />
</asp:Content>
