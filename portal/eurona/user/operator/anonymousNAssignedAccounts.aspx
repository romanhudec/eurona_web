<%@ Page Title="" Language="C#" MasterPageFile="~/user/operator/admin.master" AutoEventWireup="true" Inherits="Eurona.Operator.AnonymousAccountsPage" Codebehind="anonymousNAssignedAccounts.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
	<telerik:RadGrid AutoGenerateColumns="False" ID="gridView" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True" runat="server">
        ...
        <MasterTableView TableLayout="Fixed" PageSize = "50">
            <Columns>
                <telerik:GridHyperLinkColumn HeaderText="Reg. číslo" DataTextField="Code" DataNavigateUrlFields="AccountId"  UniqueName="Code" ItemStyle-Wrap="false" DataNavigateUrlFormatString="~/user/operator/user.aspx?id={0}&ReturnUrl=/user/operator/anonymousNAssignedAccounts.aspx"
