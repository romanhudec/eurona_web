<%@ Page Title="<%$ Resources:Reports, DnesZauctovanaProdukce_Title %>" Language="C#" MasterPageFile="~/user/advisor/reports/report.master" AutoEventWireup="true" CodeBehind="zauctovanaProdukce.aspx.cs" Inherits="Eurona.User.Advisor.Reports.ZauctovanaProdukceReport" %>
