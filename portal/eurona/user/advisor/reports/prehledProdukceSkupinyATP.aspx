<%@ Page Title="<%$ Resources:Reports, PrehledProdukceSkupinyATP_Title %>" Language="C#" MasterPageFile="~/user/advisor/reports/report.master" AutoEventWireup="true" CodeBehind="prehledProdukceSkupinyATP.aspx.cs" Inherits="Eurona.User.Advisor.Reports.PrehledProdukceSkupinyReportATP" %>
    ...
    <telerik:RadGrid AutoGenerateColumns="False" ID="gridView" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True" runat="server">
        ...
        <MasterTableView TableLayout="Fixed" PageSize = "50">
            <Columns>
				...
				<telerik:GridBoundColumn HeaderText="Eurona Stars" DataField="PocetEuronaStars" UniqueName="PocetEuronaStars"
                    SortExpression="PocetEuronaStars" AutoPostBackOnFilter="false" CurrentFilterFunction="Contains" ShowFilterIcon="false" DataFormatString="{0:F0}" />
