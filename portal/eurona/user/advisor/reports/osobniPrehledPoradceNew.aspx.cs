...
namespace Eurona.User.Advisor.Reports {
    public partial class OsobniPrehledPoradceReportNew : ReportPage {
        protected void Page_Load(object sender, EventArgs e) {
            ...
            osobniPrehledPoradceNew.ForAdvisor = this.ForAdvisor;
        ...
        private void GridViewDataBind(bool bind) {
            ...
            osobniPrehledPoradceNew.Obdobi = obdobi;
            osobniPrehledPoradceNew.GridViewDataBind(bind);
        }
    }
}