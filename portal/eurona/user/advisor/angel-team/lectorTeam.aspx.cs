...
{
	public partial class LectorTeamPage : WebPage
	{
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			List<Organization> listATPManager = Storage<Organization>.Read(new Organization.ReadByAngelTeam { AngelTeamManager = true, AngelTeamManagerTyp = (int)ATPManagerTyp.Lector1 });
			this.rpLektori.DataSource = listATPManager;
			if (!IsPostBack)
			{
				this.rpLektori.DataBind();
			}
