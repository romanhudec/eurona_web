...
<td align="center">
        ...
        <td align="center">
            ...
            <table width="100%">
                <tr><td align="center" class="item-header"><asp:Literal ID="Literal3" runat="server" Text="Bonusové kredity" /></td></tr>
                <tr><td align="center" class="item-content"><a id="A2" href="~/user/advisor/bonusovekredity.aspx" runat="server"><img src="../../images/BK_ikona.jpg" width="70px" /></a></td></tr>
                <tr><td align="center"><span style="color:#ff0000;font-weight:bold;font-size:14px;">Stav k čerpání :</span> <span style="color:#ff0000;font-weight:bold;font-size:14px;" runat="server" ID="lblStavBK"></span></td></tr>
            </table>
            </div>
        </td>
        <td align="center">
            <div class="item" id="divOrdersToAssociate">
                <a id="A3" class="item-navigation-container" runat="server" href="~/user/advisor/orderstoassociate.aspx">
                    <table width="100%">
    ...
    <tr>
        ...
        <td align="center">
            ...
            <table width="100%">
                <tr><td align="center" class="item-header"><asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:Strings, AdvisorDesktop_GrafyLideVSiti %>" /></td></tr>
                <tr><td align="center"><asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/user/advisor/charts/default.aspx"><img src="../../images/advisor-desktop-graf.png" /></asp:HyperLink></td></tr>
            </table>
            </div>
        </td>
        <td align="center">
