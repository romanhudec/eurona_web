<%@ Page Title="<%$ Resources:Strings, UserPage_PersonDetail%>" Language="C#" MasterPageFile="~/page.master" AutoEventWireup="true" CodeBehind="registerUser.aspx.cs" Inherits="Eurona.User.Advisor.RegisterUser" %>
