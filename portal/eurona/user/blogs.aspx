<%@ Page Title="<%$ Resources:Strings, Navigation_Blogs %>" Language="C#" MasterPageFile="~/page.master" AutoEventWireup="true" Inherits="Eurona.User.Blogs" Codebehind="blogs.aspx.cs" %>
