<%@ Page  Language="C#" MasterPageFile="~/page.master" AutoEventWireup="true" Inherits="Eurona.User.EmailChangeVerifycation" Codebehind="emailChangeVerifycation.aspx.cs" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="content" Runat="Server">
    <script type="text/jscript">
        ...
        function startVerifycationProcess() {
            ...
            $.ajax({
                url: "<%=Page.ResolveUrl("~/user/emailVerifycationService.ashx")%>?method=verifyChangeEmailFinish",
    ...
    <div id="verifyForm" style="display:none;">
        <div id="layoutVerifycationProcess" style="display:none;">
            <table style="text-align:center;margin: 0 auto;">
                <tr><td><h4><asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:Strings, ChangeEmailControl_Title %>"></asp:Literal></h4></td></tr>
        ...
        <div id="layoutVerifycationSuccessFinish" style="display:none;">
            <table style="text-align:center;margin: 0 auto;">
                <tr><td><h4><asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:Strings, ChangeEmailControl_Title %> "></asp:Literal></h4></td></tr>
                <tr><td><asp:Label runat="server" ID="lblFinishTitle" Text="<%$ Resources:Strings, ChangeEmailControl_VerifycationSuccessFinish_Title %>" style="text-align:center;color:#EA008A;font-size:20px;"></asp:Label></td></tr>
                <tr>
                    <td>
                        <div class="message" style="padding-top:10px;">
                            <asp:Label runat="server" ID="lblFinishMessage" Text="<%$ Resources:Strings, ChangeEmailControl_VerifycationSuccessFinish_Message %>" ></asp:Label>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnFinish" runat="server" CssClass="button" Text="<%$ Resources:Strings, ChangeEmailControl_Pokracovat %>" OnClientClick="onContinueToOffice();" />    
                    </td>
                </tr>
            </table>
        </div>
        <div id="layoutVerifycationFailed" style="display:none;">
            <table style="text-align:center;margin: 0 auto;width:100%;">
                <tr><td><h4><asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:Strings, ChangeEmailControl_Title %>"></asp:Literal></h4></td></tr>
                ...
                <tr>
                    <td style="text-align:right;padding-top:10px;">
                        <asp:Button ID="Button1" runat="server" CssClass="button" Text="<%$ Resources:Strings, ChangeEmailControl_Opakovat %>" OnClientClick="startVerifycationProcess();" />
                    </td>
                </tr>                              
            </table>
        </div>
        <div id="layoutVerifycationMessage" style="display:none;">
            <table style="text-align:center;margin: 0 auto;width:100%;">
                <tr><td><h4><asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:Strings, ChangeEmailControl_Title %>"></asp:Literal></h4></td></tr>
