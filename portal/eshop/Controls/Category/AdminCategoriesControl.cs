...
namespace SHP.Controls.Category
{
		public class AdminCategoriesControl: CmsControl
		{
				...
				private RadGrid CreateGridView()
				{
						...
						grid.MasterTableView.CommandItemSettings.AddNewRecordText = Resources.Controls.AdminCategoriesControl_NewCategoryButton_Text;

						grid.MasterTableView.Columns.Add( new GridBoundColumn
						{
								DataField = "Order",
								HeaderText = Resources.Controls.AdminCategoriesControl_ColumnOrder,
						...
						{
								DataField = "Name",
								HeaderText = Resources.Controls.AdminCategoriesControl_ColumnName,
								SortExpression = "Name",
								AutoPostBackOnFilter = true,
								CurrentFilterFunction = GridKnownFunction.Contains
						} );
						...
						{
								DataField = "Alias",
								HeaderText = Resources.Controls.AdminCategoriesControl_ColumnAlias,
								AutoPostBackOnFilter = true,
								CurrentFilterFunction = GridKnownFunction.Contains
						} );
						...
						btnSubItems.Text = Resources.Controls.AdminCategoriesControl_SubCategoriesToolTip;
						...
						btnAttributes.Text = Resources.Controls.AdminCategoriesControl_AttributesToolTip;
