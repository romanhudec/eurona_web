...
namespace Cron.Eurona.Import
{
		...
		/// </summary>
		public class CernyForLifeClsImagesSynchronize: Synchronize
		{
				...
				public CernyForLifeClsImagesSynchronize( string srcTVDImagePath, string dstParfumacieImagePath, string dstSpecialniUcinkyImagePath, MSSQLStorage srcSqlStorage )
				...
				public override void Synchronize()
				{
						...
						try
						{
								...
								try
								{
										...
										DataTable td = CernyForLifeTVDDAL.GetTVDClsSpecialniUcinky( this.SourceDataStorage );
										...
										td = CernyForLifeTVDDAL.GetTVDClsParfemace( this.SourceDataStorage );
										foreach ( DataRow row in td.Rows )
										{
