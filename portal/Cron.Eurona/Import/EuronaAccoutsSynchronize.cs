...
namespace Cron.Eurona.Import
{
	...
	/// </summary>
	public class EuronaAccoutsSynchronize : Synchronize
	{
		private int instanceId = 0;
		public EuronaAccoutsSynchronize(int instanceId, MSSQLStorage srcSqlStorage, MSSQLStorage dstSqlStorage)
			...
			using (SqlConnection connection = this.DestinationDataStorage.Connect())
			{
				try
				{
					...
					try
					{
						...
						//TVD->EURONA
						DataTable td = EuronaTVDDAL.GetTVDPoradci(this.SourceDataStorage);
