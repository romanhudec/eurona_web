...
{
	public class EuronaProductStockSynchronize : Synchronize
	{
		private int instanceId = 0;
		private int productId = 0;
		private int stockCount = 0;

		public EuronaProductStockSynchronize(int instanceId, int productId, int stockCount, MSSQLStorage srcSqlStorage, MSSQLStorage dstSqlStorage)
