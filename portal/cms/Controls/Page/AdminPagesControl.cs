...
{
		public class AdminPagesControl: CmsControl
		{
				...
				{
						get { return GetSession<SortDirection>( "AdminPagesControl-SortDirection", SortDirection.Ascending ); }
						set { SetSession<SortDirection>( "AdminPagesControl-SortDirection", value ); }
				}

				public string SortExpression
				{
						get { return GetSession<string>( "AdminPagesControl-SortExpression", "Title" ); }
						set { SetSession<string>( "AdminPagesControl-SortExpression", value ); }
				}
				...
				{
						List<PageEntity> pages = Storage<PageEntity>.Read( new PageEntity.ReadContentPages() );
				...
				private RadGrid CreateGridView()
				{
						...
						grid.MasterTableView.CommandItemSettings.AddNewRecordText = Resources.Controls.AdminPagesControl_NewPageButton_Text;
						...
						ghc.HeaderText = Resources.Controls.AdminPagesControl_ColumnTitle;
						...
						//{
						//    DataField = "Title",
						//    HeaderText = Resources.Controls.AdminPagesControl_ColumnTitle,
						...
						{
								DataField = "Name",
								HeaderText = Resources.Controls.AdminPagesControl_ColumnName,
								SortExpression = "Name",
								AutoPostBackOnFilter = true,
								CurrentFilterFunction = GridKnownFunction.Contains
						} );
						...
						{
								DataField = "RoleName",
								HeaderText = Resources.Controls.AdminPagesControl_ColumnRole,
						...
						btnEditContent.Text = Resources.Controls.GridView_ToolTip_EditContent;
				...
				void OnRowDataBound( object sender, GridItemEventArgs e )
				{
						...
						PageEntity page = e.Item.DataItem as PageEntity;
				...
				private void OnEditCommand( object sender, GridCommandEventArgs e )
				{
						...
						int pageId = Convert.ToInt32( dataItem.OwnerTableView.DataKeyValues[dataItem.ItemIndex]["Id"] );

						Response.Redirect( String.Format( EditUrlFormat, pageId ) + "&" + base.BuildReturnUrlQueryParam() );
				}
				...
				private void OnEditContentCommand( object sender, GridCommandEventArgs e )
				{
						...
						Response.Redirect( String.Format( EditContentUrlFormat, pageId ) + "&" + base.BuildReturnUrlQueryParam() );
				}
				...
				private void OnDeleteCommand( object sender, GridCommandEventArgs e )
				{
						GridDataItem dataItem = (GridDataItem)e.Item;
						int pageId = Convert.ToInt32( dataItem.OwnerTableView.DataKeyValues[dataItem.ItemIndex]["Id"] );
						if ( pageId < 0 ) return; //Systemove stranky sa nemazu.

						PageEntity page = Storage<PageEntity>.ReadFirst( new PageEntity.ReadById { PageId = pageId } );

						Storage<PageEntity>.Delete( page );
